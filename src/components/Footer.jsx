...
const Footer = () => {
  return (
    <footer className="w-full bg-white py-18 border-t border-gray-200">
      <div className="container mx-auto px-4 sm:px-6 flex flex-col sm:flex-row items-center justify-between">
        <h2 className="lg:ml-9 text-2xl sm:text-3xl lg:text-4xl font-bold mt-4 sm:mt-0">
          devFlow.
        </h2>

        <div className="flex space-x-4 mt-4 sm:mt-0 lg:mr-15">
          <a
